...
import com.andriikichmarenko.attendancecheckup.broadcast.BroadcastActivity;
import com.andriikichmarenko.attendancecheckup.ranging.RanginActivity;
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            case R.id.bt_checkup:
                intent = new Intent(this, RanginActivity.class);
